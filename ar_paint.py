...
def main():
    ...
    if args['use_numeric_painting']:
        ...
        painted_image = cv2.imread('./imagem_pintada.png')
        image_to_paint = cv2.imread('./imagem_numerada.png')

        l = combine(blank_image, image_to_paint)
